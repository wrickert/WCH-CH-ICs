...
static const uint8_t consumer_hid_desc[] = {
    ...
    HID_COLLECTION(HID_COLLECTION_APPLICATION),    // COLLECTION (Application)
        ...
        HID_INPUT(0x01),                           // INPUT (Const,Array,Abs)
...
static const uint8_t mouse_hid_desc[] = {  //From http://eleccelerator.com/tutorial-about-usb-hid-report-descriptors/
	...
	HID_USAGE( HID_USAGE_CONSUMER_CONTROL ),  // USAGE (Mouse)
	HID_COLLECTION ( HID_COLLECTION_APPLICATION ),    // COLLECTION (Application)
		HID_USAGE( HID_USAGE_CONSUMER_CONTROL ),       //   USAGE (Pointer)
...
// Consumer Control Device
	...
	1,                  // bNumEndpoints
	0x03,               // bInterfaceClass (0x03 = HID)
	0x01,               // bInterfaceSubClass (Change to appropriate subclass for consumer control)
	0x01,               // bInterfaceProtocol (Change to appropriate protocol for consumer control)
	0,                  // iInterface

	9,                  // bLength
	0x21,               // bDescriptorType (HID)
	0x10, 0x01,         // bcdHID (HID version 1.1)
	0x00,               // bCountryCode (not used)
	0x01,               // bNumDescriptors
	0x22,               // bDescriptorType[0] (HID)
	sizeof(consumer_hid_desc), 0x00, // wDescriptorLength (total length of HID report descriptor)
	...
	10,                  // bInterval (10 ms polling interval)
...
//	{0x00002200, mouse_hid_desc, sizeof(mouse_hid_desc)},
   {0x00002200, consumer_hid_desc, sizeof(consumer_hid_desc)},  // Consumer HID Descriptor
